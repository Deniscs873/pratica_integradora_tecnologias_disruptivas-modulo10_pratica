    ...
    <Grid container justifyContent="center" spacing={2}>
      <Card sx={style}>
        <CardHeader
          ...
          subheader="Atualize as informações da tarefa"
          sx={{ backgroundColor: '#1976d2', color: '#fff' }} // Estilo do header
        />
        <CardContent sx={{ bgcolor: '#f5f5f5' }}> // Fundo do conteúdo
          <Grid item xs={12}>
...
const style = {
  ...
  width: '60%',
  bgcolor: '#fff', // Cor de fundo do card
  boxShadow: 24, // Sombra do card
  p: 4,
};
